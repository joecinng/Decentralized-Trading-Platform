          ...
          <div class="col-lg-7 my-lg-0 my-3">
            <div class="table-responsive my-2">
              <div class="btn-group py-4" role="group" aria-label="Basic example">
                <button type="button" class="btn btn-secondary"><a href="/" class="text-white"><h6 class="my-1 mx-2">All</h6></a></button>
                <button type="button" class="btn"><a href="/" class="text-white"><h6 class="my-1 mx-2">Music</h6></a></button>
                <button type="button" class="btn"><a href="/" class="text-white"><h6 class="my-1 mx-2">Fantom</h6></a></button>
                <button type="button" class="btn"><a href="/" class="text-white"><h6 class="my-1 mx-2">Art</h6></a></button>
                <button type="button" class="btn"><a href="/" class="text-white"><h6 class="my-1 mx-2">Token</h6></a></button>
              </div>
            </div>
          </div>
        ...
        <div class="w-100 row align-items-center">
          {temp.map(asset => (
            ...
            <div key={asset.id} className="p-3 my-3 bg-dark shadow-lg card text-white rounded border border-secondary">
              <img class="w-100 card-img explore-card-image" src={asset.image} alt="item"/>
