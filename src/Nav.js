...
function Nav({ cart, count }) {
    ...
    return (
      <nav className="navbar navbar-expand-lg bg-dark shadow-lg w-100">
        <a href="/" className="navbar-brand text-white px-4">
          <img src={Logo} height={55} width={70} alt="Logo" />
        </a>
        ...
        <div className="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
          <ul className="navbar-nav">
            <li className="nav-item p-2">
              <a href="/activity" className="nav-link text-white">History</a>
            </li>
            <li className="nav-item p-2">
              <a href="/" className="nav-link text-white">Browse Assets</a>
            </li>
          </ul>
    ...
    <div className="dropdown-menu dropdown-menu-right "  aria-labelledby="dropdownMenuButton">
        ...
        style={{ zIndex: 10, transform: 'translate(50%, -50%)', backgroundColor: 'rgba(255,255,255,0.6)' }}><span class="material-symbols-outlined">
        remove
        </span>
    </button>
                        </div>
