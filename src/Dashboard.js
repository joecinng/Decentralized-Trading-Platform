          ...
          <div className="col-12 ">
            <div className=" h-100">
              ...
              <div className="col-12 text-start p-4">
                <div className="col-sm-12 mx-auto m-3 p-5 rounded-5">
                  <h1>Activity</h1>
                  <h5 className="mt-5 py-2">Previous Purchases</h5>
                  <div className="w-100">
                      ...
                      <tbody>
                        {transactionHistory.map((tx, index) => (
                          <tr className="border-0" key={index}>
                             <td className="py-3 border-0"><img src="https://htmlcolorcodes.com/assets/images/colors/blue-green-color-solid-background-1920x1080.png" class="rounded-5" width="50px" height="50px" /></td>
